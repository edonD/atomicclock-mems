...
module \$paramod$18b93113afd5e95091b6118f8450d434eb1927df\pid_controller (clk, rst_n, ce, adc_in, dac_out, error_out);
  ...
  sky130_fd_sc_hd__nor3b_1 _406_ (
    .A(_266_),
    .B(_118_),
    .C_N(_079_),
    .Y(_119_)
  ...
  sky130_fd_sc_hd__and3b_1 _455_ (
    .A_N(_164_),
    .B(_165_),
    .C(_167_),
    .X(_168_)
  ...
  sky130_fd_sc_hd__nor3b_1 _471_ (
    .A(error_out[8]),
    .B(_079_),
    .C_N(_118_),
    .Y(_184_)
  );
  sky130_fd_sc_hd__o21a_1 _472_ (
    .A1(_119_),
    .A2(_184_),
    .B1(_183_),
    .X(_185_)
  ...
  sky130_fd_sc_hd__o21ba_1 _514_ (
    .A1(_224_),
    .A2(_225_),
    .B1_N(_185_),
    .X(_227_)
  ...
  sky130_fd_sc_hd__o211ai_1 _522_ (
    .A1(_230_),
    .A2(_233_),
    .B1(ce),
    .C1(_228_),
  ...
  sky130_fd_sc_hd__o211ai_1 _525_ (
    .A1(_230_),
    .A2(_235_),
    .B1(ce),
    .C1(_228_),
  ...
  sky130_fd_sc_hd__o211ai_1 _531_ (
    .A1(_230_),
    .A2(_239_),
    .B1(ce),
    .C1(_228_),
  ...
  sky130_fd_sc_hd__o211ai_1 _540_ (
    .A1(_230_),
    .A2(_245_),
    .B1(ce),
    .C1(_228_),
  ...
  sky130_fd_sc_hd__o211ai_1 _543_ (
    .A1(_230_),
    .A2(_247_),
    .B1(ce),
    .C1(_228_),
...
module \$paramod$74022849048c4ca2c8ecba9bfd9e4131fdde2054\cdc_bus_sync (clk_src, rst_src_n, capture, data_src, clk_dst, rst_dst_n, data_dst, valid_dst);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  \$paramod\cdc_sync2\STAGES=s32'00000000000000000000000000000010  u_sync_toggle (
    .clk_dst(clk_dst),
    .din(toggle_src),
    .dout(toggle_dst),
    .rst_n(rst_dst_n)
...
module \$paramod$7cf0fe596977cff7b278c78abdd480924a4e1e5b\freq_divider (clk, rst_n, count, ce_servo, ce_1hz, heartbeat);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  sky130_fd_sc_hd__a31oi_1 _058_ (
    .A1(count[0]),
    .A2(count[1]),
    .A3(count[2]),
    .B1(count[3]),
  ...
  sky130_fd_sc_hd__nand4_1 _075_ (
    .A(count[10]),
    .B(count[11]),
    .C(count[12]),
    .D(_038_),
...
module \$paramod$be25ec696c047e930657739635afb7f0ca015d5d\lock_detector (clk, rst_n, ce, error, locked);
  ...
  sky130_fd_sc_hd__a211oi_1 _53_ (
    .A1(ce),
    .A2(_15_),
    .B1(_25_),
    .C1(_26_),
  ...
  sky130_fd_sc_hd__a2bb2oi_1 _55_ (
    .A1_N(locked),
    .A2_N(_27_),
    .B1(_15_),
    .B2(ce),
...
module \$paramod$c6166734c642cd312e3c542551ce5a5c4f55a478\thermal_controller (clk, rst_n, ce, temp_adc, heater_pwm);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
...
module \$paramod\cdc_sync2\STAGES=s32'00000000000000000000000000000010 (clk_dst, rst_n, din, dout);
  input clk_dst;
  wire clk_dst;
  input din;
  wire din;
...
module \$paramod\reset_sync\STAGES=s32'00000000000000000000000000000010 (clk, rst_async_n, rst_sync_n);
  input clk;
  wire clk;
  input rst_async_n;
  wire rst_async_n;
...
module csac_digital_top(clk_vco, spi_clk, reset_n, photo_adc, temp_adc, dac_vco_tune, dac_heater_power, spi_mosi, spi_miso, spi_cs, count_1hz, valid_lock, status_byte);
  ...
  \$paramod$74022849048c4ca2c8ecba9bfd9e4131fdde2054\cdc_bus_sync  u_cdc_to_spi (
    .capture(ce_servo),
    .clk_dst(spi_clk),
    .clk_src(clk_vco),
  ...
  \$paramod$7cf0fe596977cff7b278c78abdd480924a4e1e5b\freq_divider  u_divider (
    .ce_1hz(ce_1hz),
    .ce_servo(ce_servo),
    .clk(clk_vco),
    .heartbeat(heartbeat),
  ...
  \$paramod\reset_sync\STAGES=s32'00000000000000000000000000000010  u_rst_vco (
    .clk(clk_vco),
    .rst_async_n(reset_n),
  ...
  \$paramod$c6166734c642cd312e3c542551ce5a5c4f55a478\thermal_controller  u_thermal (
    .ce(ce_servo),
    .clk(clk_vco),
...
module spi_regmap(sclk, rst_n, cs_n, rx_valid, rx_data, tx_data, count_1hz_s, status_byte_s, dac_vco_tune_s, dac_heater_s, photo_adc_s, temp_adc_s);
  ...
  sky130_fd_sc_hd__mux2i_1 _055_ (
    .A0(addr_latch[1]),
    .A1(rx_data[1]),
    .S(_000_),
    .Y(_002_)
